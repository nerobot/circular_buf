...
// TODO: Check if circular_buf_struct definition can be hidden away in the .c file
...
circular_buf_t * circular_buf_create(uint8_t capacity, uint8_t * p_buf_array, circular_buf_t * p_circular_buf);

// DONE Check if there is anything that can be done here, now I'm not using alloc
